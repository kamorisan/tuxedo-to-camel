...
/* #ident	"@(#) gp/libgp/mach/linux_ev.h	$Revision: 1.10 $" */
...
#ifndef NOWHAT
static	char	h_tmenv[] = "@(#) gp/libgp/mach/linux_ev.h	$Revision: 1.10 $";
#endif
...
#define _TMDLLENTRY
#define _TM_CDECL
/* Used in Windows NT for Borland Compiler #7688216 */
#define _COMPATIBLE_TMDLLEXPORT
