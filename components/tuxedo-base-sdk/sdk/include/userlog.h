...
/* #ident	"@(#) gp/libgp/userlog.h	$Revision: 1.7 $" */
#ifndef USERLOG_H
#define USERLOG_H
...
#ifndef NOWHAT
static	char	h_userlog[] = "@(#) gp/libgp/userlog.h	$Revision: 1.7 $";
#endif
...
enum DLogLevel {DLOG_UNDEF, DLOG_TRACE, DLOG_DEBUG, DLOG_INFO, DLOG_WARN, DLOG_ERROR, DLOG_FATAL, DLOG_NONE};
...
#ifdef WIN32
#include <stdio.h>
extern int _TM_FAR __cdecl _COMPATIBLE_TMDLLEXPORT userlog _((char _TM_FAR *, ...));
extern int _TM_FAR __cdecl _COMPATIBLE_TMDLLEXPORT duserlog _((enum DLogLevel, const char _TM_FAR *, ...));
#else
extern int _TM_FAR _TM_CDECL userlog _((char _TM_FAR *, ...));
extern int _TM_FAR _TM_CDECL duserlog _((enum DLogLevel, const char _TM_FAR *, ...));
#endif
