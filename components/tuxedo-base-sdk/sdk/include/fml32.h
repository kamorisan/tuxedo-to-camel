...
/* #ident	"@(#) fml/libfml/fml32.h	$Revision: 1.25 $" */
#ifndef TMENV_H
#include <tmenv.h>
#endif
#ifndef NOWHAT
static	char	h_fml32[] = "@(#) fml/libfml/fml32.h	$Revision: 1.25 $";
#endif
...
#define FNOTRECORD 21		/* not record buffer */
#define FRFSYNTAX 22 		/* bad recordfile */
#define FRFOPEN 23		/* cannot find or open recordfile */
#define FBADRECORD 24		/* cannot find or get record */
#define FMAXVAL 25 		/* top of error message codes */
...
/* record item types  */
#define C_SHORT		0	/* short int */
#define C_LONG		1	/* long int */
#define C_CHAR		2	/* character */
#define C_FLOAT		3	/* single-precision float */
#define C_DOUBLE	4	/* double-precision float */
#define C_STRING	5	/* string - null terminated */
#define C_CARRAY	6	/* character array */
#define C_INT		7	/* 7 reserved for FLD_INT (see viewmap.h) */
#define C_DECIMAL 	8	/* 8 reserved for FLD_DECIMAL (see viewmap.h) */
#define C_PTR		9	/* pointer */
#define C_FML32		10	/* embedded FML32 buffer */
#define C_VIEW32	11	/* embedded VIEW32 */
#define C_MBSTRING	12	/* embedded multibyte codeset info */
#define C_FML		13 /* for embedded ptr to FML buffer */
#define C_BOOL		14
#define C_UCHAR		15
#define C_SCHAR		16
#define C_WCHAR		17
...
/* flag option in RECORD APIs */
#define TPENC_ASCII		0x01	/* character encoding is ASCII format */
#define TPENC_EBCDIC		0x02	/* character encoding is EBCDIC format */
#define TPENC_BIG_ENDIAN	0x04	/* big endian */
#define TPENC_LITTLE_ENDIAN	0x08	/* little endian */
#define TPENC_MAINFRAME_FLOAT   0x10    /* mainframe float*/

/*RETURN value for Rget, Rset */
#define ROK         0
#define RCONFLICTOK 1
...
struct RECORD {
	char rname[FRECORDNAMESIZE];	/* name of record */
	char magic;			/* magic number */
	char flag;			/* flag options */
	char fld;			/* unused */
	unsigned int rsize;		/* size of RECORD data, same as copybook length */
	char rdata[1];			/* data of the RECORD, length is rsize */
};
...
extern int _TMDLLENTRY Frboolev _((struct RECORD *, char _TM_FAR *));
...
extern int _TMDLLENTRY Fsprint32 _((FBFR32 _TM_FAR *, char _TM_FAR *));
...
extern void _TMDLLENTRY Frrefresh _((void));
extern int _TMDLLENTRY Frneeded _((char _TM_FAR *));
...
extern char _TM_FAR * _TMDLLENTRY Frboolco _((char _TM_FAR *, char _TM_FAR *, char _TM_FAR *));
extern char _TM_FAR * _TMDLLENTRY Frboolcobyindex _((char _TM_FAR *, char _TM_FAR *, int));
...
/* some functions for record buffer */
extern int _TMDLLENTRY Rinit _((struct RECORD *, char *, int, int));
extern int _TMDLLENTRY Rget _((struct RECORD *, char *, char *, int, int *, int));
extern int _TMDLLENTRY Rset _((struct RECORD *, char *, char *, int, int, int));
extern int _TMDLLENTRY Fvrtos32 _((struct RECORD *, char *, char *, char *, long));
extern int _TMDLLENTRY Fvstor32 _((struct RECORD *, char *, char *, char *, long));
extern int _TMDLLENTRY Fvrtof32 _((FBFR32 *, struct RECORD *, char *, int, long));
extern int _TMDLLENTRY Fvftor32 _((FBFR32 *,struct RECORD *, char *, long));
